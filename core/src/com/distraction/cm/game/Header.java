...
public class Header {
    ...
    public void setBackClizkListener(ClickListener backListener){
    ...
    public void click(float mx, float my){
        if(back.contains(mx, my) && backListener != null){
            backListener.onClick();
        }
        if(refreshVisible && refresh.contains(mx, my) && refreshListener != null){
